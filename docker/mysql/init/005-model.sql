...
CREATE TABLE IF NOT EXISTS `SW_SYS_MODEL` (
  ...
  `MODEL_PARENT` bigint DEFAULT NULL,
  `MODEL_MODULE` varchar(255) DEFAULT NULL,
  `MODEL_AUTOID` tinyint(1) NOT NULL DEFAULT '0',
  `MODEL_IDPROPERTY` bigint DEFAULT NULL,
  `MODEL_DEFAULTFORMAT` varchar(255) DEFAULT NULL,
  `MODEL_TYPE` int DEFAULT NULL,
  `MODEL_ISVIEW` tinyint(1) NOT NULL DEFAULT '0',
  `MODEL_CON` text,
  `MODEL_DEFAULTLISTVIEW` bigint DEFAULT NULL,
  `MODEL_DEFAULTITEMVIEW` bigint DEFAULT NULL,
  ...
  KEY `ix_sw_sys_model_parent` (`MODEL_PARENT`),
  KEY `ix_sw_sys_model_id_property` (`MODEL_IDPROPERTY`),
  KEY `ix_sw_sys_model_default_list_view` (`MODEL_DEFAULTLISTVIEW`),
  KEY `ix_sw_sys_model_default_item_view` (`MODEL_DEFAULTITEMVIEW`),
...
INSERT INTO `SW_SYS_CON` (
  `SW_SYS_CON_DATASOURCE`, `SW_SYS_CON_INITALCATALOG`, `SW_SYS_CON_USERNAME`,
  `SW_SYS_CON_PASSWORD`, `SW_SYS_CON_INTEGRATEDSECURITY`, `SW_SYS_CON_ISLOACL`
)
VALUES ('mysql:3306', 'car_wash', 'root', 'Pa88word', 0, 0)
ON DUPLICATE KEY UPDATE
  `SW_SYS_CON_PASSWORD` = VALUES(`SW_SYS_CON_PASSWORD`),
  `SW_SYS_CON_INTEGRATEDSECURITY` = VALUES(`SW_SYS_CON_INTEGRATEDSECURITY`),
  `SW_SYS_CON_ISLOACL` = VALUES(`SW_SYS_CON_ISLOACL`);
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_PARENT` bigint DEFAULT NULL AFTER `MODEL_DATABASETABLE`, ADD KEY `ix_sw_sys_model_parent` (`MODEL_PARENT`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_PARENT'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_IDPROPERTY` bigint DEFAULT NULL AFTER `MODEL_AUTOID`, ADD KEY `ix_sw_sys_model_id_property` (`MODEL_IDPROPERTY`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_IDPROPERTY'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_DEFAULTFORMAT` varchar(255) DEFAULT NULL AFTER `MODEL_IDPROPERTY`',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_DEFAULTFORMAT'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_TYPE` int DEFAULT NULL AFTER `MODEL_DEFAULTFORMAT`',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_ISVIEW` tinyint(1) NOT NULL DEFAULT ''0'' AFTER `MODEL_TYPE`',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_ISVIEW'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_DEFAULTLISTVIEW` bigint DEFAULT NULL AFTER `MODEL_CON`, ADD KEY `ix_sw_sys_model_default_list_view` (`MODEL_DEFAULTLISTVIEW`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_DEFAULTLISTVIEW'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MODEL` ADD COLUMN `MODEL_DEFAULTITEMVIEW` bigint DEFAULT NULL AFTER `MODEL_DEFAULTLISTVIEW`, ADD KEY `ix_sw_sys_model_default_item_view` (`MODEL_DEFAULTITEMVIEW`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MODEL'
    AND COLUMN_NAME = 'MODEL_DEFAULTITEMVIEW'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_TYPE` int DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_TYPE'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_SOURCEPROPERTY` bigint DEFAULT NULL, ADD KEY `ix_sw_sys_relation_source_property` (`SW_SYS_RELATION_SOURCEPROPERTY`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_SOURCEPROPERTY'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_TARGETPROPERTY` bigint DEFAULT NULL, ADD KEY `ix_sw_sys_relation_target_property` (`SW_SYS_RELATION_TARGETPROPERTY`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_TARGETPROPERTY'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_TABLE` varchar(255) DEFAULT NULL, ADD KEY `ix_sw_sys_relation_table` (`SW_SYS_RELATION_TABLE`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_TABLE'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_SOURCECOL` varchar(255) DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_SOURCECOL'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_TARGETCOL` varchar(255) DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_TARGETCOL'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_RELATION` ADD COLUMN `SW_SYS_RELATION_CANBENULL` tinyint(1) DEFAULT ''0''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_RELATION'
    AND COLUMN_NAME = 'SW_SYS_RELATION_CANBENULL'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_CONTYPE` int DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_CONTYPE'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_MODEL` bigint DEFAULT NULL, ADD KEY `ix_sw_sys_property_property_model` (`PROPERTY_MODEL`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_MODEL'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_ISARRAY` tinyint(1) NOT NULL DEFAULT ''0''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_ISARRAY'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_COLNAME` varchar(255) DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_COLNAME'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_PROPERTYNAME` varchar(255) DEFAULT NULL, ADD KEY `ix_sw_sys_property_name` (`PROPERTY_PROPERTYNAME`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_PROPERTYNAME'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_MULTIMAP` tinyint(1) NOT NULL DEFAULT ''0''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_MULTIMAP'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_IXGRPOUP` varchar(255) DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_IXGRPOUP'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_ISCHECK` tinyint(1) NOT NULL DEFAULT ''0''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_ISCHECK'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_GENERATIONTYPE` int DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_GENERATIONTYPE'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_ALLOWDBNULL` tinyint(1) NOT NULL DEFAULT ''1''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_ALLOWDBNULL'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_CANGET` tinyint(1) NOT NULL DEFAULT ''1''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_CANGET'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_CANSET` tinyint(1) NOT NULL DEFAULT ''1''',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_CANSET'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_FILTER` text',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_FILTER'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_SOURCE` text',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_FORMAT` text',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_FORMAT'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `PROPERTY_SQLCON` text',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'PROPERTY_SQLCON'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_PROPERTY` ADD COLUMN `SW_SYS_MODEL_PropertiesSysId` bigint DEFAULT NULL, ADD KEY `ix_sw_sys_property_owner` (`SW_SYS_MODEL_PropertiesSysId`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_PROPERTY'
    AND COLUMN_NAME = 'SW_SYS_MODEL_PropertiesSysId'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MULTIMAP` ADD COLUMN `MAP_NAME` varchar(255) DEFAULT NULL, ADD KEY `ix_sw_sys_multimap_name` (`MAP_NAME`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MULTIMAP'
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MULTIMAP` ADD COLUMN `MAP_COLNAME` varchar(255) DEFAULT NULL',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MULTIMAP'
    AND COLUMN_NAME = 'MAP_COLNAME'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @ddl = (
  SELECT IF(
    COUNT(*) = 0,
    'ALTER TABLE `SW_SYS_MULTIMAP` ADD COLUMN `SW_SYS_PROPERTY_DBMapsSysId` bigint DEFAULT NULL, ADD KEY `ix_sw_sys_multimap_owner` (`SW_SYS_PROPERTY_DBMapsSysId`)',
    'SELECT 1'
  )
  FROM information_schema.COLUMNS
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME = 'SW_SYS_MULTIMAP'
    AND COLUMN_NAME = 'SW_SYS_PROPERTY_DBMapsSysId'
);
PREPARE stmt FROM @ddl;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
