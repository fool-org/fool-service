...
VALUES (7001, 100, '删除', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL)
ON DUPLICATE KEY UPDATE
...
VALUES (7001, 100, '删除', 7001, NULL, 0, 2, 1, NULL)
ON DUPLICATE KEY UPDATE
...
VALUES (7001, '删除', NULL, 7001, '操作成功', '操作失败', '确定要删除？该操作不可撤消', 0, '确定要删除？该操作不可撤消')
ON DUPLICATE KEY UPDATE
