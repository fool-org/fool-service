...
VALUES
  (7001, 100, '删除', 7001, NULL, 0, 2, 1, NULL),
  (7002, 100, '保存', 7002, NULL, 0, 3, 1, NULL)
ON DUPLICATE KEY UPDATE
...
VALUES
  (7001, '删除', NULL, 7001, '操作成功', '操作失败', '确定要删除？该操作不可撤消', 0, '确定要删除？该操作不可撤消'),
  (7002, '保存', NULL, 7002, '保存成功', '保存失败', '确定要保存？', 0, '确定要保存？')
ON DUPLICATE KEY UPDATE
