...
LEGACY_CORE_SCHEMA_COLUMNS = (
    ...
    ("fool_sys_model", "name"),
    ("fool_sys_model", "text"),
    ("fool_sys_model", "remark"),
    ("fool_sys_model", "model_type"),
    ("fool_sys_model", "class_name"),
    ("fool_sys_model", "table_name"),
    ("fool_sys_model", "auto_sys_id"),
    ("fool_sys_model", "id_property"),
    ("fool_sys_model", "default_owner"),
    ("fool_sys_model_property", "id"),
    ("fool_sys_model_property", "name"),
    ("fool_sys_model_property", "remark"),
    ("fool_sys_model_property", "property_model"),
    ("fool_sys_model_property", "is_collection"),
    ("fool_sys_model_property", "owner"),
    ("fool_sys_model_property", "filter"),
    ("fool_sys_model_property", "source"),
    ("fool_sys_model_property", "format"),
    ("fool_sys_model_property", "column"),
    ("fool_sys_model_property", "property_type"),
    ("fool_sys_model_property", "allow_db_null"),
    ("fool_sys_model_property", "is_check"),
    ("fool_sys_model_property", "ix_group"),
    ("fool_sys_model_property", "generation_type"),
    ("fool_sys_model_property", "generation_expression"),
    ("fool_sys_model_property", "default_value"),
    ("fool_sys_model_property", "multi_map"),
    ("fool_sys_view", "id"),
    ("fool_sys_view", "view_name"),
    ("fool_sys_view", "view_text"),
    ("fool_sys_view", "view_remark"),
    ("fool_sys_view", "view_title"),
    ("fool_sys_view", "view_type"),
    ("fool_sys_view", "view_model"),
    ("fool_sys_view", "filter"),
    ("fool_sys_view", "auto_fresh_interval"),
    ("fool_sys_view", "view_model_class"),
    ("fool_sys_view_item", "id"),
    ("fool_sys_view_item", "item_name"),
    ("fool_sys_view_item", "item_label"),
    ("fool_sys_view_item", "item_legend"),
    ("fool_sys_view_item", "model_property"),
    ("fool_sys_view_item", "input_type"),
    ("fool_sys_view_item", "can_edit"),
    ("fool_sys_view_item", "select_view_name"),
    ("fool_sys_view_item", "input_regx"),
    ("fool_sys_view_item", "format_regx"),
    ("fool_sys_view_item", "edit_type"),
    ("fool_sys_view_item", "show_index"),
    ("fool_sys_view_item", "width"),
    ("fool_sys_view_item", "source_expression"),
    ("fool_sys_view_item", "list_view_id"),
    ("fool_sys_view_item", "edit_view_id"),
    ("fool_sys_view_item", "selected_view_id"),
