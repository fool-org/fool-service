...
- 2026-07-03: added legacy `runoperation`
  ...
  Collection/list property method execution, external-model operation
  execution, constructor/parameter commands, and trigger side effects remain
  future work.
