...
- 2026-07-03: extended legacy `runoperation`
  ...
  item before the base operation save/delete/create step. `ExuteListMethod`
  list-object execution, external-model operation execution,
  constructor/parameter commands, and trigger side effects remain future work.
- 2026-07-03: added legacy `runoperation`
  ...
  `ExuteListMethod` list-object execution, external-model operation execution,
  constructor/parameter commands, and trigger side effects remain future work.
