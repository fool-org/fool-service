...
- 2026-07-03: added legacy `querydatadetail` static `IdExp` object-id
  ...
  controller to service. Auth/context expressions and first-row fallback remain
  future work.
...
- 2026-07-03: added legacy `runoperation` `Filter` command execution.
  ...
  trigger side effects, and non-`SetValue` executable command types remain
  future work.
