...
- Compare report setup/result footer commands with old `view.jade`.
- Remove invented return, cancel, run, and save icons.
- Preserve command visibility, disabled states, and handlers.
...
- Authenticated report-footer visual inspection requires a fresh CAPTCHA
  authorization.

## Risks And Follow-Ups

- Final browser acceptance should verify setup and result footer states at
