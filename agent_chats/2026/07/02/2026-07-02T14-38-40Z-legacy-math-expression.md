...
- Added legacy `MathExpression` behavior in `fool-common`.
- Preserved operator detection, variable resolution, parentheses, arithmetic
  precedence, formatted numeric results, and invalid-expression fallback to
  `0`.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/data/math/MathExpression.java`
- `fool-common/src/test/java/org/fool/framework/common/data/math/MathExpressionTest.java`
...
- The parser covers the legacy four-operator and parentheses surface; any
  undocumented legacy parsing quirks should be added only when a concrete
  compatibility case appears.
