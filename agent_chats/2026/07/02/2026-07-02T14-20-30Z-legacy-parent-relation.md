# Legacy Parent Relation Metadata
...
- Added legacy `ParentRelationAttribute` metadata as `ParentRelation` in
  `fool-common`.
- Preserved parent property and ORM column name metadata.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/annotation/ParentRelation.java`
- `fool-common/src/test/java/org/fool/framework/common/annotation/ParentRelationTest.java`
...
- Full root `mvn test` was not run; this slice only adds isolated metadata.

## Risks And Follow-Ups

- Parent-relation runtime behavior remains outside this metadata-only slice.
