# Legacy Serial Number Attribute
...
- Added legacy `SerialNoObject` attribute metadata as `SerialNo` in
  `fool-common`.
- Preserved length, date format, and serial prefix metadata.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/annotation/SerialNo.java`
- `fool-common/src/test/java/org/fool/framework/common/annotation/SerialNoTest.java`
...
- Runtime serial-number generation remains outside this metadata-only slice.
