...
- Added legacy misspelled `BusinesObjectsWithItem` wrapper in `fool-common`.
- Preserved the nullable `SubItemList<T>` `List` property surface.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/data/BusinesObjectsWithItem.java`
- `fool-common/src/test/java/org/fool/framework/common/data/BusinesObjectsWithItemTest.java`
...
- Full root `mvn test` was not run; this slice only adds an isolated
  `fool-common` wrapper type.

## Risks And Follow-Ups

- None for this wrapper surface.
