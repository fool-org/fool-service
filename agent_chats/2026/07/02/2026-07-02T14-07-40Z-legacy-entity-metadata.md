...
- Added legacy `EntityAttribute` metadata as the `Entity` annotation in
  `fool-common`.
- Preserved runtime availability and the optional display name value.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/annotation/Entity.java`
- `fool-common/src/test/java/org/fool/framework/common/annotation/EntityTest.java`
...
- Runtime consumers for entity display names remain outside this metadata-only
  slice.
