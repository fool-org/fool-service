...
- Added legacy `SerialNoObject` interface in `fool-common`.
- Preserved the `SerialNoLen` length property surface as JavaBean accessors.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/data/SerialNoObject.java`
- `fool-common/src/test/java/org/fool/framework/common/data/SerialNoObjectTest.java`
...
- Serial number generation behavior remains outside this interface-only slice.
