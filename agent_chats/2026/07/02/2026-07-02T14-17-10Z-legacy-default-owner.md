...
- Added legacy `DefaultOwnerAttribute` as a runtime `DefaultOwner` marker in
  `fool-common`.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/annotation/DefaultOwner.java`
- `fool-common/src/test/java/org/fool/framework/common/annotation/DefaultOwnerTest.java`
...
- Full root `mvn test` was not run; this slice only adds one isolated marker
  annotation.

## Risks And Follow-Ups

- Runtime default-owner semantics remain outside this metadata-only slice.
