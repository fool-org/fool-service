...
- Added legacy `IController` interface in `fool-common`.
- Preserved `get`, paged `getList`, `create`, `update`, and `delete` method
  surfaces.
- Updated the migration parity document.

## Changed Files

- `fool-common/src/main/java/org/fool/framework/common/data/IController.java`
- `fool-common/src/test/java/org/fool/framework/common/data/IControllerTest.java`
...
- Concrete controller implementations remain outside this interface-only slice.
